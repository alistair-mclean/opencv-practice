...
layer3 = create_new_conv_layer(layer2, 64, 64, [5,5], [2,2], name='layer3')

flattened = tf.reshape(layer3, [-1, 7*7*64])
...
wd2 = tf.Variable(tf.truncated_normal([1000, 1000], stddev=0.3), name='wd2')
bd2 = tf.Variable(tf.truncated_normal([1000], stddev=0.01), name='bd2')
dense_layer2 = tf.matmul(dense_layer1, wd2) + bd2

wd3 = tf.Variable(tf.truncated_normal([1000, 10], stddev=0.3), name='wd3')
